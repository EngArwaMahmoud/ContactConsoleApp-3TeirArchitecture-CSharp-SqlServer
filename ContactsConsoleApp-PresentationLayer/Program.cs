...
namespace ContactsConsolApp
{
    internal class Program
    {
...

        {
            ...
            Contact1.DateOfBirth = new DateTime(2003, 2, 8, 10, 30, 0);
...

        {
            ...
            if (Contact1 != null)
            {
                ...
                Contact1.FirstName = "Arwa";
                Contact1.LastName = "Mahmoud";
                Contact1.Email = "arwam3562@gmail.com";
                Contact1.Phone = "01025226786";
                Contact1.Address = "Tanta";
                Contact1.DateOfBirth = new DateTime(2003, 2, 8, 10, 30, 0);
                Contact1.CountryID = 1;
                Contact1.ImagePath = "";
...

        {
            ...
            if (Country1 != null)
            {
                //update whatever info you want
                Country1.CountryName = "Egypt";
                Country1.CountryCode = "123";
                Country1.PhoneCode = "311";
